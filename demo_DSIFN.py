...
def get_args():
    ...
    parser.add_argument('--gpu_ids', type=str, default='0,1,2,3,4,5', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--project_name', default='CrossTransNext_7', type=str)
    parser.add_argument('--checkpoint_root', default='/mnt/nfs/data/pycharm_project_489/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_DSIFN/CrossTransNext_7', type=str)
    ...
    parser.add_argument('--net_G', default='TransNext', type=str,
